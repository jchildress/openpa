...
//		super(model, new ObsIslandBldrNew(model, debug).constructIndex());
    ...
    static void printBusDetail(ObservableIslandList olist, File outdir)
...
class to perform detailed tracing and debugging of the algorithms.
        *
        *@author chris@powerdata.com
	 *
             */
