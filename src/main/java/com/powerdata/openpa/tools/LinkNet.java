...
public class LinkNet {
     ...
     *
     * @param fromBusNdx From bus index of branch
     * @param toBusNdx   To bus index of branch
     * @return branch index
     */
...
//
     ...
     */
    public int getConnectionCount(int busNdx) {
        return _cnt[busNdx];
    }
