...
public class BusConnectionsPriQ {
     ...
     *
     * @param counts array of connection counts for each bus.
     */
     ...
     *
     * @param f function to apply on each bus
     ...
     *
     * @param bus bus to increment the number of connections
     */
     ...
     *
     * @param bus bus to decrement the number of connections
