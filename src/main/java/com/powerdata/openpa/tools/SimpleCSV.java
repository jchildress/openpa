...
public class SimpleCSV {
    ...
    public int getColCount() {
        return (_colNames != null) ? _colNames.length : 0;
    }
    ...
    public byte getByte(int col, int row) {
        return Byte.parseByte(get(col, row));
    }

    public short getShort(int col, int row) {
        return Short.parseShort(get(col, row));
    }

    public int getInt(int col, int row) {
        return Integer.parseInt(get(col, row));
    }

    public long getLong(int col, int row) {
        return Long.parseLong(get(col, row));
    }

    public float getFloat(int col, int row) {
        return Float.parseFloat(get(col, row));
    }

    public double getDouble(int col, int row) {
        return Double.parseDouble(get(col, row));
    }
    ...
    public byte getByte(String col, int row) {
        return Byte.parseByte(get(col, row));
    }
    ...
    public int getInt(String col, int row) {
        return Integer.parseInt(get(col, row));
    }
    ...
    public boolean hasCol(String col) {
        return (_colsByName.get(col) != null);
    }

    public long[] getLongs(int col) {
        return getLongs(get(col));
    }

    public long[] getLongs(String col) {
        return getLongs(get(col));
    }
    ...
    public float[] getFloats(int col) {
        return getFloats(get(col));
    }

    public float[] getFloats(String col) {
        return getFloats(get(col));
    }
    ...
    public short[] getShorts(int col) {
        return getShorts(get(col));
    }

    public short[] getShorts(String col) {
        return getShorts(get(col));
    }
    ...
    public boolean[] getBooleans(int col) {
        return getBooleans(get(col));
    }

    public boolean[] getBooleans(String col) {
        return getBooleans(get(col));
    }
    ...
    public int[] getInts(int col) {
        return getInts(get(col));
    }

    public int[] getInts(String col) {
        return getInts(get(col));
    }
    ...
    public double[] getDoubles(int col) {
        return getDoubles(get(col));
    }

    public double[] getDoubles(String col) {
        return getDoubles(get(col));
    }
    ...
    public void set(int col, int row, byte val) {
        set(col, row, String.valueOf(val));
    }
    ...
    //
    public String set(String col, int row, String val) {
        return _colsByName.get(col).set(row, val);
    }

    public void set(String col, int row, byte val) {
        set(col, row, String.valueOf(val));
    }

    public void set(String col, int row, short val) {
        set(col, row, String.valueOf(val));
    }

    public void set(String col, int row, int val) {
        set(col, row, String.valueOf(val));
    }

    public void set(String col, int row, long val) {
        set(col, row, String.valueOf(val));
    }

    public void set(String col, int row, float val) {
        set(col, row, String.valueOf(val));
    }

    public void set(String col, int row, double val) {
        set(col, row, String.valueOf(val));
    }
    ...
    public int addRow() throws Exception {
        ...
        for (ArrayList<String> col : _cols) {
            col.add("");
        }
        ++_rowCount;
        return _rowCount;
