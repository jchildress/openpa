...

{
    ...
    public class EliminatedNodeList extends AbstractList<EliminatedNode> {
        ...
        @Override
        public EliminatedNode get(int ndx) {
            return new EliminatedNode(ndx);
        }
    ...
    public class EliminatedNode {
         ...
         */
        public int getElimNodeNdx() {
            return _elimndorder[_ndx];
        }
        /**
         *
         * @return
