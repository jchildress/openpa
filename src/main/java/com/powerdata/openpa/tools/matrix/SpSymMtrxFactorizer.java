...
public abstract class SpSymMtrxFactorizer {
    protected int[]    /** eliminated node order */
            _elimndorder = new int[0], _ep = new int[0],
     ...
     *
     * @param elimnode Node being eliminated
     * @param cnd      connected node indexes
     * @param cedge    connected edge indexes
     */
     ...
     *
     * @param imut   index of the mutual record in operation
     * @param adjbr  off-diagonal mutual connection
     * @param targbr id of target branch
     */
