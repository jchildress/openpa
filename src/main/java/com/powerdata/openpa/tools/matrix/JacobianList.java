...
public interface JacobianList extends List<JacobianElement> {
     ...
     */
    default void decDpdv(int ndx, float v) {
        incDpdv(ndx, -v);
    }
     ...
     */
    default void decDqda(int ndx, float v) {
        incDqda(ndx, -v);
    }
     ...
     */
    default void decDqdv(int ndx, float v) {
        incDqdv(ndx, -v);
    }
    ...
    static class Element implements com.powerdata.openpa.tools.matrix.JacobianElement {
        ...
        public Element(JacobianList l, int ndx) {
            _ndx = ndx;
            _list = l;
        }
