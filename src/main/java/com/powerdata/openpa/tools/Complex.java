...
public class Complex {
     ...
     * add two complex numbers
     */
    public Complex add(float re2, float im2) {
     ...
     * subtract two complex numbers
     */
    public Complex sub(float re2, float im2) {
        return new Complex(_re - re2, _im - im2);
    }
     ...
     */
    public Complex mult(float scalar) {
     ...
     */
    public Complex div(float scalar) {
        return new Complex(_re / scalar, _im / scalar);
    }
     ...
     */
    public PComplex polar() {
        return new PComplex(abs(), (float) Math.atan2(_im, _re));
    }
