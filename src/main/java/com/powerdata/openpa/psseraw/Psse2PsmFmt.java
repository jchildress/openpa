...
public class Psse2PsmFmt extends PsseProcessor {
     ...
     *
     * @param rawpsse     The input PSS/e raw file
     * @param specversion Override the version for PSS/e files that may not have it in
     *                    the headers
     * @param outdir      output directory for CSV files. If this directory does not
     *                    exist, it is created
     * @throws IOException
