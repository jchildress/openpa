...
**
    ...
    @
            oid
    writeRatioTap(TxData.WndData w) {
...
**
    ...
    oid writePhaseShifterRecord(TxData txd) {
        writeTransformer(txd);
        writeWinding(txd, 1);
    ...
    void writePhaseTap(TxData.WndData w) {
    ...
    interface WindingConvFunction {
         ...
         *
         * @param v    read-in string from raw PSS/e data
         * @param base relative voltage for default. For example, a winding
    ...
    interface VoltageBandConvFunction {
         ...
         *
         * @param v    read-in string from raw PSS/e data
         * @param base relative voltage for default. For example, voltage control
