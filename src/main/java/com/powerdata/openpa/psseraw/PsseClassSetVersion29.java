...
public class PsseClassSetVersion29 extends PsseClassSet {
    ...
    @Override
    public PsseClass getLoad() {
        return Load;
    }

    @Override
    public PsseClass getGenerator() {
        return Generator;
    }
    ...
    @Override
    public PsseClass getTransformer() {
        return Transformer;
    }

    @Override
    public PsseClass getAreaInterchange() {
        return AreaInterchange;
    }

    @Override
    public PsseClass getTwoTermDCLine() {
        return TwoTerminalDCLine;
    }

    @Override
    public PsseClass getVSC_DCLine() {
        return VSC_DCLine;
    }

    @Override
    public PsseClass getSwitchedShunt() {
        return SwitchedShunt;
    }

    @Override
    public PsseClass getTxImpedanceCorrection() {
        return TxImpedanceCorrection;
    }

    @Override
    public PsseClass getMultiTermDC_ACConv() {
        return MultiTermDC_ACConv;
    }

    @Override
    public PsseClass getMultiTermDCBus() {
        return MultiTermDCBus;
    }

    @Override
    public PsseClass getMultiTermDCLink() {
        return MultiTermDCLink;
    }

    @Override
    public PsseClass getMultiTermDCLine() {
        return MultiTermDCLine;
    }

    @Override
    public PsseClass getMultiSectionLine() {
        return MultiSectionLine;
    }

    @Override
    public PsseClass getZone() {
        return Zone;
    }

    @Override
    public PsseClass getInterAreaTransfer() {
        return InterAreaTransfer;
    }

    @Override
    public PsseClass getOwner() {
        return Owner;
    }

    @Override
    public PsseClass getFACTSDevice() {
        return FACTSDevice;
    }
