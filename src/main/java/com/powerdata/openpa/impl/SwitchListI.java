...
public class SwitchListI extends TwoTermDevListI<Switch> implements SwitchList {
    static final TwoTermDevEnum _PFld = new TwoTermDevEnum() {
        ...
        public ColumnMeta id() {
            return ColumnMeta.SwID;
        }

        @Override
        public ColumnMeta name() {
            return ColumnMeta.SwNAME;
        }

        @Override
        public ColumnMeta fbus() {
            return ColumnMeta.SwBUSFROM;
        }

        @Override
        public ColumnMeta tbus() {
            return ColumnMeta.SwBUSTO;
        }

        @Override
        public ColumnMeta insvc() {
            return ColumnMeta.SwINSVC;
        }

        @Override
        public ColumnMeta fp() {
            return ColumnMeta.SwPFROM;
        }

        @Override
        public ColumnMeta fq() {
            return ColumnMeta.SwQFROM;
        }

        @Override
        public ColumnMeta tp() {
            return ColumnMeta.SwPTO;
        }

        @Override
        public ColumnMeta tq() {
            return ColumnMeta.SwQTO;
        }
    };
