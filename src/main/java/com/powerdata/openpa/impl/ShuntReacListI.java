...
public class ShuntReacListI extends FixedShuntListI<ShuntReactor> implements ShuntReacList {
    static final ShuntEnum _PFld = new ShuntEnum() {
        ...
        public ColumnMeta id() {
            return ColumnMeta.ShreacID;
        }

        @Override
        public ColumnMeta name() {
            return ColumnMeta.ShreacNAME;
        }

        @Override
        public ColumnMeta bus() {
            return ColumnMeta.ShreacBUS;
        }

        @Override
        public ColumnMeta p() {
            return ColumnMeta.ShreacP;
        }

        @Override
        public ColumnMeta q() {
            return ColumnMeta.ShreacQ;
        }

        @Override
        public ColumnMeta insvc() {
            return ColumnMeta.ShreacINSVC;
        }

        @Override
        public ColumnMeta b() {
            return ColumnMeta.ShreacB;
        }
    };
