...
public class EmptyLists {
    ...
    private static final class EmptyBusList extends EmptyGroup<Bus> implements BusList {
        ...
        @Override
        public int getFreqSrcPri(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setFreqSrcPri(int ndx, int fsp) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public int[] getFreqSrcPri() {
            return new int[0];
        }

        @Override
        public void setFreqSrcPri(int[] fsp) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public ElectricalIsland getIsland(int ndx) {
            throw new IndexOutOfBoundsException();
        }
    ...
    private abstract static class EmptyInServiceList<T extends InService> extends EmptyBase<T> implements InServiceList<T> {
        @Override
        public boolean isInService(int ndx) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setInService(int ndx, boolean s) {
            throw new IndexOutOfBoundsException();
        }
    ...
    private static abstract class EmptyTwoTermDevList<T extends TwoTermDev> extends EmptyInServiceList<T> implements TwoTermDevListIfc<T> {
        ...
        @Override
        public float getFromP(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setFromP(int ndx, float mw) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setFromP(float[] mw) {
            throw new UnsupportedOperationException();
        }

        @Override
        public float getFromQ(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setFromQ(int ndx, float mvar) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float[] getFromQ() {
            return new float[0];
        }

        @Override
        public void setFromQ(float[] mvar) {
            throw new UnsupportedOperationException();
        }

        @Override
        public float getToP(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setToP(int ndx, float mw) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setToP(float[] mw) {
            throw new UnsupportedOperationException();
        }

        @Override
        public float getToQ(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setToQ(int ndx, float mvar) {
            throw new IndexOutOfBoundsException();
        }
    ...
    private static final class EmptySVCList extends EmptyOneTermDevList<SVC> implements SVCList {
        ...
        @Override
        public void setSlope(int ndx, float slope) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public SVCState getOutputMode(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public SVCState[] getOutputMode() {
            return new SVCState[0];
        }

        @Override
        public void setOutputMode(SVCState[] m) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setOutputMode(int ndx, SVCState m) {
            throw new IndexOutOfBoundsException();
        }
    ...
    private static abstract class EmptyACBranchList<T extends ACBranch> extends EmptyTwoTermDevList<T> implements ACBranchListIfc<T> {
        ...
        @Override
        public float[] getLTRating() {
            return new float[0];
        }

        @Override
        public void setLTRating(float[] mva) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setLTRating(int ndx, float mva) {
            throw new IndexOutOfBoundsException();
        }
    }
    ...
    private static final class EmptyPhaseShifterList extends EmptyACBranchList<PhaseShifter> implements PhaseShifterList {
        @Override
        public ControlMode getControlMode(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public ControlMode[] getControlMode() {
            return new ControlMode[0];
        }
        ...
        @Override
        public void setControlMode(int ndx, ControlMode m) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public boolean hasReg(int ndx) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setReg(int ndx, boolean v) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setReg(boolean[] v) {
            throw new UnsupportedOperationException();
        }

        @Override
        public float getMaxAng(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setMaxAng(int ndx, float v) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setMaxAng(float[] v) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float getMinAng(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setMinAng(int ndx, float v) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setMinAng(float[] v) {
            throw new UnsupportedOperationException();
        }

        @Override
        public float getRegMaxMW(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float[] getRegMaxMW() {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setRegMaxMW(float[] mw) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setRegMaxMW(int ndx, float mw) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float getRegMinMW(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setRegMinMW(int ndx, float mw) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float[] getRegMinMW() {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setRegMinMW(float[] mw) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private static final class EmptyTransformerList extends EmptyACBranchList<Transformer> implements TransformerList {
        @Override
        public boolean isRegEnabled(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setRegEnabled(int ndx, boolean enabl) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setRegEnabled(boolean[] enabl) {
            throw new UnsupportedOperationException();
        }

        @Override
        public Bus getTapBus(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public Bus[] getTapBus() {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setTapBus(Bus[] s) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setTapBus(int ndx, Bus s) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float getMinKV(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setMinKV(int ndx, float kv) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setMinKV(float[] kv) {
            throw new UnsupportedOperationException();
        }

        @Override
        public float getMaxKV(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setMaxKV(int ndx, float kv) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setHasLTC(int ndx, boolean b) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setHasLTC(boolean[] b) {
            throw new UnsupportedOperationException();
        }

        @Override
        public float getFromMinTap(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setFromMinTap(int ndx, float a) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setFromMinTap(float[] a) {
            throw new UnsupportedOperationException();
        }

        @Override
        public float getToMinTap(int ndx) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setToMinTap(float[] a) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setToMinTap(int ndx, float a) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float getFromMaxTap(int ndx) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setFromMaxTap(float[] a) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setFromMaxTap(int ndx, float a) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float getToMaxTap(int ndx) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setToMaxTap(float[] a) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setToMaxTap(int ndx, float a) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float getFromStepSize(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float[] getFromStepSize() {
            return new float[0];
        }

        @Override
        public void setFromStepSize(float[] step) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setFromStepSize(int ndx, float step) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float getToStepSize(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public float[] getToStepSize() {
            return new float[0];
        }

        @Override
        public void setToStepSize(float[] step) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void setToStepSize(int ndx, float step) {
            throw new IndexOutOfBoundsException();
        }
    }
    ...
    private static final class EmptySwitchList extends EmptyTwoTermDevList<Switch> implements SwitchList {
        ...
        @Override
        public float getTransitTime(int ndx) {
            throw new IndexOutOfBoundsException();
        }

        @Override
        public void setTransitTime(int ndx, float t) {
            throw new IndexOutOfBoundsException();
        }
        ...
        @Override
        public void setTransitTime(float[] t) {
            throw new UnsupportedOperationException();
        }
    }
