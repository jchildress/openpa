...
public class PhaseShifterListI extends TransformerBaseListI<PhaseShifter> implements PhaseShifterList {
    static final TransBaseEnum _PFld = new TransBaseEnum() {
        ...
        public ColumnMeta fbus() {
            return ColumnMeta.PhashBUSFROM;
        }

        @Override
        public ColumnMeta tbus() {
            return ColumnMeta.PhashBUSTO;
        }

        @Override
        public ColumnMeta insvc() {
            return ColumnMeta.PhashINSVC;
        }

        @Override
        public ColumnMeta fp() {
            return ColumnMeta.PhashPFROM;
        }

        @Override
        public ColumnMeta fq() {
            return ColumnMeta.PhashQFROM;
        }

        @Override
        public ColumnMeta tp() {
            return ColumnMeta.PhashPTO;
        }

        @Override
        public ColumnMeta tq() {
            return ColumnMeta.PhashQTO;
        }

        @Override
        public ColumnMeta id() {
            return ColumnMeta.PhashID;
        }

        @Override
        public ColumnMeta name() {
            return ColumnMeta.PhashNAME;
        }

        @Override
        public ColumnMeta r() {
            return ColumnMeta.PhashR;
        }

        @Override
        public ColumnMeta x() {
            return ColumnMeta.PhashX;
        }

        @Override
        public ColumnMeta gmag() {
            return ColumnMeta.PhashGMAG;
        }

        @Override
        public ColumnMeta bmag() {
            return ColumnMeta.PhashBMAG;
        }

        @Override
        public ColumnMeta shift() {
            return ColumnMeta.PhashANG;
        }

        @Override
        public ColumnMeta ftap() {
            return ColumnMeta.PhashTAPFROM;
        }

        @Override
        public ColumnMeta ttap() {
            return ColumnMeta.PhashTAPTO;
        }

        @Override
        public ColumnMeta ratLT() {
            return ColumnMeta.PhashRATLT;
        }
    };
