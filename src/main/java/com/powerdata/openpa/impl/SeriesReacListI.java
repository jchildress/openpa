...
public class SeriesReacListI extends ACBranchListI<SeriesReac> implements SeriesReacList {
    static final ACBranchEnum _PFld = new ACBranchEnum() {
        ...
        public ColumnMeta fbus() {
            return ColumnMeta.SerreacBUSFROM;
        }

        @Override
        public ColumnMeta tbus() {
            return ColumnMeta.SerreacBUSTO;
        }

        @Override
        public ColumnMeta insvc() {
            return ColumnMeta.SerreacINSVC;
        }

        @Override
        public ColumnMeta fp() {
            return ColumnMeta.SerreacPFROM;
        }

        @Override
        public ColumnMeta fq() {
            return ColumnMeta.SerreacQFROM;
        }

        @Override
        public ColumnMeta tp() {
            return ColumnMeta.SerreacPTO;
        }

        @Override
        public ColumnMeta tq() {
            return ColumnMeta.SerreacQTO;
        }

        @Override
        public ColumnMeta id() {
            return ColumnMeta.SerreacID;
        }

        @Override
        public ColumnMeta name() {
            return ColumnMeta.SerreacNAME;
        }

        @Override
        public ColumnMeta r() {
            return ColumnMeta.SerreacR;
        }

        @Override
        public ColumnMeta x() {
            return ColumnMeta.SerreacX;
        }

        @Override
        public ColumnMeta ratLT() {
            return ColumnMeta.SerreacRATLT;
        }
    };


    public SeriesReacListI() {
        super();
    }
