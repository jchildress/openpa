...
public class ShuntCapListI extends FixedShuntListI<ShuntCapacitor> implements ShuntCapList {
    static final ShuntEnum _PFld = new ShuntEnum() {
        ...
        public ColumnMeta id() {
            return ColumnMeta.ShcapID;
        }

        @Override
        public ColumnMeta name() {
            return ColumnMeta.ShcapNAME;
        }

        @Override
        public ColumnMeta bus() {
            return ColumnMeta.ShcapBUS;
        }

        @Override
        public ColumnMeta p() {
            return ColumnMeta.ShcapP;
        }

        @Override
        public ColumnMeta q() {
            return ColumnMeta.ShcapQ;
        }

        @Override
        public ColumnMeta insvc() {
            return ColumnMeta.ShcapINSVC;
        }

        @Override
        public ColumnMeta b() {
            return ColumnMeta.ShcapB;
        }
    };
