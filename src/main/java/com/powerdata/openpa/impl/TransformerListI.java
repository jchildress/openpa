...
public class TransformerListI extends TransformerBaseListI<Transformer> implements TransformerList {
    static final TransBaseEnum _PFld = new TransBaseEnum() {
        ...
        public ColumnMeta fbus() {
            return ColumnMeta.TfmrBUSFROM;
        }

        @Override
        public ColumnMeta tbus() {
            return ColumnMeta.TfmrBUSTO;
        }

        @Override
        public ColumnMeta insvc() {
            return ColumnMeta.TfmrINSVC;
        }

        @Override
        public ColumnMeta fp() {
            return ColumnMeta.TfmrPFROM;
        }

        @Override
        public ColumnMeta fq() {
            return ColumnMeta.TfmrQFROM;
        }

        @Override
        public ColumnMeta tp() {
            return ColumnMeta.TfmrPTO;
        }

        @Override
        public ColumnMeta tq() {
            return ColumnMeta.TfmrQTO;
        }

        @Override
        public ColumnMeta id() {
            return ColumnMeta.TfmrID;
        }

        @Override
        public ColumnMeta name() {
            return ColumnMeta.TfmrNAME;
        }

        @Override
        public ColumnMeta r() {
            return ColumnMeta.TfmrR;
        }

        @Override
        public ColumnMeta x() {
            return ColumnMeta.TfmrX;
        }

        @Override
        public ColumnMeta gmag() {
            return ColumnMeta.TfmrGMAG;
        }

        @Override
        public ColumnMeta bmag() {
            return ColumnMeta.TfmrBMAG;
        }

        @Override
        public ColumnMeta shift() {
            return ColumnMeta.TfmrANG;
        }

        @Override
        public ColumnMeta ftap() {
            return ColumnMeta.TfmrTAPFROM;
        }

        @Override
        public ColumnMeta ttap() {
            return ColumnMeta.TfmrTAPTO;
        }

        @Override
        public ColumnMeta ratLT() {
            return ColumnMeta.TfmrRATLT;
        }
    };
