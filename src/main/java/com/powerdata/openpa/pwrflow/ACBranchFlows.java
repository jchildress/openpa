...
public interface ACBranchFlows extends
    ...
    public static class ACBranchFlow extends ACBranchExt {
        ...
        public float getFromPpu() {
            return _list.getFromPpu(_ndx);
        }

        public float getFromQpu() {
            return _list.getFromQpu(_ndx);
        }

        public float getToPpu() {
            return _list.getToPpu(_ndx);
        }

        public float getToQpu() {
            return _list.getToQpu(_ndx);
        }
