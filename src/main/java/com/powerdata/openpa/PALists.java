...
public interface PALists {
     ...
     *
     * @throws PAModelException Method uses reflection to find all one-terminal device lists
     */
     ...
     *
     * @throws PAModelException Method uses reflection to find all two-terminal devices
     */
     ...
     * get all AC Branches
     *
     * @throws PAModelException Method uses reflection to find all ACBranch devices
     */
